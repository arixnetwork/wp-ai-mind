                    ...
                    <tbody>
                        {breakdown.map((row, i) => (
                            <tr key={i}>
                                ...
                                <td style={{ color: 'var(--color-text-muted)' }}>{row.feature}</td>
                                <td style={{ textAlign: 'right' }}>{parseInt(row.tokens).toLocaleString()}</td>
                                <td style={{ textAlign: 'right' }}>${parseFloat(row.cost).toFixed(4)}</td>
