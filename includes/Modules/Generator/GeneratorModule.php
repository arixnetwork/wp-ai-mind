...
class GeneratorModule {
    ...
    public static function enqueue_assets( string $hook ): void {
        ...
        if ( ! isset( $_GET['page'] ) || $_GET['page'] !== 'wp-ai-mind-generator' ) {
            return;
        }
    ...
    public static function register_routes(): void {
        \register_rest_route( 'wp-ai-mind/v1', '/generate', [
            'methods'             => \WP_REST_Server::CREATABLE,
            'callback'            => [ self::class, 'handle_generate' ],
            'permission_callback' => fn() => \current_user_can( 'edit_posts' ),
            'args'                => [
                'title'    => [ 'type' => 'string', 'required' => true,  'sanitize_callback' => 'sanitize_text_field' ],
                'keywords' => [ 'type' => 'string', 'required' => false, 'sanitize_callback' => 'sanitize_text_field', 'default' => '' ],
                'tone'     => [ 'type' => 'string', 'required' => false, 'sanitize_callback' => 'sanitize_text_field', 'default' => 'professional' ],
                'length'   => [ 'type' => 'string', 'required' => false, 'sanitize_callback' => 'sanitize_text_field', 'default' => 'medium', 'enum' => [ 'short', 'medium', 'long' ] ],
            ],
        ] );
    }
    ...
    public static function handle_generate( \WP_REST_Request $request ): \WP_REST_Response {
        ...
        $length_map = [ 'short' => '300–500', 'medium' => '600–900', 'long' => '1200–1800' ];
        ...
        try {
            ...
            $req = new \WP_AI_Mind\Providers\CompletionRequest(
                ...
                temperature: 0.7,
                max_tokens:  2000,
                metadata:    [ 'feature' => 'generator', 'post_title' => $title ]
            );
